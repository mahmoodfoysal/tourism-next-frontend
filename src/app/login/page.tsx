...
import { loginWithEmail, loginWithGoogle, setError } from '@/store/slices/authSlice';
...
const LoginPage = () => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        e.preventDefault();
        showProcessing("Signing In", "Please wait while we verify your credentials...");
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center">
                                    ...
                                    <Link href="#" className="text-xs font-bold text-primary hover:underline transition-all">
                                        Forgot Password?
                                    </Link>
                                </div>
                                <input 
                            ...
                            <div className="flex items-center gap-2 px-1">
                                ...
                                <label htmlFor="remember" className="text-sm font-medium text-base-content/60 cursor-pointer select-none">
