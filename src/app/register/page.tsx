...
const RegisterPage = () => {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        e.preventDefault();
        showProcessing("Creating Account", "Please wait while we set up your premium profile...");
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-12">
                        <div className="space-y-4 translate-y-0 opacity-100 transition-all duration-700 delay-300">
                            ...
                            <p className="text-white/70 text-lg max-w-md leading-relaxed">
                                Join thousands of travelers who have found their perfect getaway. Your premium travel experience starts here.
                            </p>
                            <div className="flex items-center gap-4 pt-4">
                                ...
                                <span className="text-white/80 text-sm font-medium">Joined by 10k+ explorers</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="w-full max-w-md mx-auto space-y-8">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-base-100 px-4 text-base-content/40 font-bold">Or continue with email</span>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleRegister} className="space-y-4">
                            <div className="space-y-1.5">
                                <label className="text-sm font-bold ml-1 text-base-content/70">Full Name</label>
                                <input 
                                    type="text" 
                                    placeholder="Alex Johnson" 
                                    className="input input-bordered w-full h-14 rounded-2xl bg-base-200/50 border-transparent focus:border-primary focus:bg-base-100 transition-all px-6 font-medium"
                                    value={name}
                            ...
                            <div className="space-y-1.5">
                                <label className="text-sm font-bold ml-1 text-base-content/70">Email Address</label>
                                <input 
                                    type="email" 
                            ...
                            <div className="space-y-1.5">
                                <label className="text-sm font-bold ml-1 text-base-content/70">Password</label>
                                <input 
                                    type="password" 
                                    placeholder="••••••••" 
                                    className="input input-bordered w-full h-14 rounded-2xl bg-base-200/50 border-transparent focus:border-primary focus:bg-base-100 transition-all px-6 font-medium"
                            ...
                            <div className="flex items-start gap-2 px-1 py-2">
                                <input type="checkbox" className="checkbox checkbox-primary checkbox-sm rounded-md mt-0.5" id="terms" required />
                                <label htmlFor="terms" className="text-sm font-medium text-base-content/60 cursor-pointer select-none">
                                    I agree to the <Link href="#" className="text-primary font-bold hover:underline">Terms</Link> & <Link href="#" className="text-primary font-bold hover:underline">Privacy</Link>
                                </label>
                            </div>
