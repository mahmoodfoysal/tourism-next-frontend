...
const FAQ = () => {
    const faqs = [
        ...
        },
        {
            ...
            answer: "We offer flexible cancellation policies. For most packages, you can cancel up to 14 days before departure for a full refund. Specific terms may vary based on the destination and seasonal demand."
        },
        {
            id: 3,
            question: "Are your tours family-friendly?",
            answer: "Absolutely! We specialize in family travel and offer specific packages designed with kids in mind, including child-friendly accommodations, educational tours, and plenty of fun activities for all ages."
        },
        {
            id: 4,
            question: "Do you provide travel insurance?",
            answer: "Yes, we highly recommend travel insurance and offer several comprehensive plans that cover medical emergencies, trip cancellations, and lost luggage to give you total peace of mind during your journey."
        },
        {
            id: 5,
            question: "Can I customize a travel package?",
            answer: "We love creating unique experiences! You can work with our travel experts to customize any existing package or build a completely new itinerary from scratch based on your interests and budget."
        }
    ];
                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-1/3">
                        ...
                        <p className="text-lg text-base-content/60 leading-relaxed mb-10">
                            Everything you need to know about our tours, bookings, and policies. Cant find the answer? Feel free to reach out.
                        </p>
                        
                        <div className="p-8 rounded-3xl bg-base-200/50 border border-base-content/5">
                            <h4 className="text-xl font-black text-base-content mb-2">Still have questions?</h4>
                            <p className="text-sm text-base-content/50 mb-6">Our support team is here to help you 24 hours a day, 7 days a week.</p>
