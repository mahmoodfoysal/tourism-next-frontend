  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between gap-2 border-t-2 pt-2 border-base-content/5">
          <span className="text-sm font-black text-base-content/80 mb-3 transition-colors leading-tight ">
            {info.tour_date}
          </span>
          <span className="text-sm font-black text-base-content/80 mb-3 transition-colors leading-tight">
            {info.duration}
        ...
        <div className="flex items-center justify-between gap-2  pt-1">
          <span className="text-[12px] font-black text-base-content/60 mb-3 transition-colors leading-tight ">
            {info.shortDescription}
          </span>
        </div>

        <div className="mt-auto pt-2 border-t border-base-content/5">
          <div className="flex items-center justify-between mb-4">
            {info.originalPrice ? (
              <div className="flex gap-2">
                <span className="text-sm text-red-600 line-through font-black tracking-widest uppercase">
                  ${info.originalPrice}
                </span>
